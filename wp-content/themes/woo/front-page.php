...
?>
	<main id="primary" class="site-main">
			...
			<div id="carouselExampleDark" class="carousel carousel-dark slide overflow-hidden rounded">
				...
				<div class="carousel-inner">
					<div class="carousel-item active" data-bs-interval="10000">
						<a href="#"><img src="<?php echo get_template_directory_uri();?>/img/slider/slide-1.jpg" loading="lazy" class="d-block w-100" alt="..."></a>
					</div>
					<div class="carousel-item" data-bs-interval="2000">
						<a href="#"><img src="<?php echo get_template_directory_uri();?>/img/slider/slide-2.jpg" loading="lazy" class="d-block w-100" alt="..."></a>
					</div>
				</div>
		...
		<section class="container">
			...
			<p class="text-center">We offer a number of hight quality toys to help keeps<br> your pets healthy and spoiled!</p>
			<div class="pt-5 pb-5">
				...
				<div class="row pt-5">
					<div class="categories__col col-md-4 col-sm-12 mb-3">
						<a href="#" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
							...
							<h2 class="position-absolute bottom-0 start-0 end-0 p-2 mb-0 text-center bg-primary-8 text-white">Toys</h2>
						</a>
					</div>
					<div class="categories__col col-md-4 col-sm-12 mb-3">
						<a href="#" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
							...
							<h2 class="position-absolute bottom-0 start-0 end-0 p-2 mb-0 text-center bg-primary-8 text-white">Food</h2>
						</a>
					</div>
					<div class="categories__col col-md-4 col-sm-12 mb-3">
						<a href="#" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
							...
							<h2 class="position-absolute bottom-0 start-0 end-0 p-2 mb-0 text-center bg-primary-8 text-white">Care</h2>
						</a>
					</div>
				</div>
				<div class="row mb-3">
					<div class="categories__col col-md-4 col-sm-12 mb-3">
						<a href="#" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
							...
							<h2 class="position-absolute bottom-0 start-0 end-0 p-2 mb-0 text-center bg-primary-8 text-white">Accessories</h2>
						</a>
					</div>
